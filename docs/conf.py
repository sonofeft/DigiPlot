...
target_file = os.path.join( up_one, 'digiplot','_version.py')
...
#html_logo = "./_static/digiplot.png"
...
latex_documents = [
  (master_doc, 'DigiPlot.tex', u'DigiPlot Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'DigiPlot Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'DigiPlot', u'DigiPlot Documentation',
   author, 'DigiPlot', 'One line description of project.',
   'Miscellaneous'),
]
